...
@section('title','إضافة للهيئة العامه للرقابة على الصادرات والواردات')
@section('Pbody')
@section('id', request()->route('id'))

<div class="container d-flex flex-column justify-content-center align-items-center" >
    <h1 class="m-3">إضافة للهيئة العامه للرقابة على الصادرات والواردات</h1>
    <form class="row g-3 mt-5" action="/AddCSDoc" method="POST" enctype="multipart/form-data">
@csrf
...
<input required type="hidden" value="1" name="filetype">
  <div class="col-md-12">
    <label for="doc_file" class="form-label">الملف</label>
