...
@section('title','إضافة سجل تجاري')
@section('Pbody')
@section('id', request()->route('id'))

<div class="container d-flex flex-column justify-content-center align-items-center" >
    <h1 class="m-3">إضافة سجل تجاري</h1>
    <form class="row g-3 mt-5" action="/AddCommercialRegistry" method="POST" enctype="multipart/form-data">
@csrf
...
<input required type="hidden" value="2" name="filetype">
  <div class="col-md-6">
    <label for="doc_file" class="form-label">ملف السجل</label>
  ...
  <div class="col-12 text-center mb-5">
    <button type="submit" class="btn btn-primary">إضافة السجل التجاري</button>
  </div>
</form>
</div>
@endsection