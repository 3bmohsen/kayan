...
<div class="container d-flex flex-column justify-content-center align-items-center" >
    <h1 class="m-3">إضافة دورة تدريبية</h1>
    <form class="row g-3 mt-5" action="/AddCourse" method="POST" enctype="multipart/form-data">
@csrf
<input required type="hidden" value="{{request()->route('id')}}" name="client_id" id="client_id">
<input required type="hidden" value="7" name="filetype">
  <div class="col-md-6">
