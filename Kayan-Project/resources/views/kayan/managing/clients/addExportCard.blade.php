...
@section('title','إضافة البطاقة التصديرية')
@section('Pbody')
@section('id', request()->route('id'))


<div class="container d-flex flex-column justify-content-center align-items-center" >
    <h1 class="m-3">إضافة البطاقة التصديرية</h1>
    <form class="row g-3 mt-5" action="/addExportCard" method="POST" enctype="multipart/form-data">
@csrf
