...
@section('title','إقرارات ضريبة كسب العمل')
@section('Pbody')
@section('id', request()->route('id'))

<div class="container d-flex flex-column align-items-center justify-content-center">
<h2 class="text-center" style=" font-weight: bold; ">إقرارات  ضريبة كسب العمل</h2>
<hr style="    border: 3px solid black;width: 200px;">
<a href="/addIncomeTaxDoc/{{request()->route('id')}}"><div class="btn btn-success">إضافة إقرار جديد</div></a>
</div>
@if(session('success'))
...
<div class="container mt-3">
    ...
    @livewire('income-tax-docs-list', ['id' =>request()->route('id')])
