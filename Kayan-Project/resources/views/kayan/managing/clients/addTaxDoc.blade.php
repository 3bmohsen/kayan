...
@section('title','إضافة إقرار ضريبي')
@section('Pbody')
@section('id', request()->route('id'))

<div class="container d-flex flex-column justify-content-center align-items-center" >
    <h1 class="m-3">إضافة إقرار ضريبي</h1>
<form class="row g-3 mt-5" action="/addTaxDoc" method="POST" enctype="multipart/form-data">
  @csrf
  ...
  <textarea required  class="form-control" id="exampleFormControlTextarea1" name="notes" id="notes" rows="3"></textarea>
</div>
