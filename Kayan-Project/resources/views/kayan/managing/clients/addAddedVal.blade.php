...
@section('title','إضافة شهادة القيمة المضافة')
@section('Pbody')
@section('id', request()->route('id'))

<div class="container d-flex flex-column justify-content-center align-items-center" >
    <h1 class="m-3">إضافة شهادة جديدة</h1>
    <form class="row g-3 mt-5" action="/addAddedVal" method="POST" enctype="multipart/form-data">
@csrf
...
<input required type="hidden" value="3" name="filetype">
  ...
  <div class="col-12 text-center mb-5">
    <button type="submit" class="btn btn-primary">إضافة الشهادة </button>
  </div>
</form>
</div>
@endsection