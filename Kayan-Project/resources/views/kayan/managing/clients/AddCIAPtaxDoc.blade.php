...
@section('title','إضافة إقرار ضريبةالارباح التجارية والصناعية')
@section('Pbody')
@section('id', request()->route('id'))

<div class="container d-flex flex-column justify-content-center align-items-center" >
    <h1 class="m-3">إضافة إقرار ضريبة الارباح التجارية والصناعية</h1>
    <form class="row g-3 mt-5" action="/AddCIAPtaxDoc" method="POST" enctype="multipart/form-data">
@csrf
