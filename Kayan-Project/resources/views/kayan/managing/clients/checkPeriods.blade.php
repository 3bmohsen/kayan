...
@section('title','فترات الفحص')
@section('Pbody')
@section('id', request()->route('id'))
<div class="container d-flex flex-column align-items-center justify-content-center">
<h2 class="text-center" style=" font-weight: bold; ">فترات الفحص</h2>
<hr style="    border: 3px solid black;width: 200px;">
<a href="/AddCheckPeriod/{{request()->route('id')}}"><div class="btn btn-success">إضافة إقرار جديد</div></a>
</div>
@if(session('success'))
...
<div class="container mt-3">
    ...
    @livewire('periods-list', ['id' =>request()->route('id')])
    </div>
</div>
