...
@section('title','إضافة للغرفة التجارية')
@section('Pbody')
@section('id', request()->route('id'))

<div class="container d-flex flex-column justify-content-center align-items-center" >
    <h1 class="m-3">إضافة للغرفة التجارية</h1>
    <form class="row g-3 mt-5" action="/AddCOCDoc" method="POST" enctype="multipart/form-data">
@csrf
