...
@section('title','إضافة للهيئة العامه لللإستثمار')
@section('Pbody')
@section('id', request()->route('id'))

<div class="container d-flex flex-column justify-content-center align-items-center" >
    <h1 class="m-3">إضافة للهيئة العامه لللإستثمار</h1>
    <form class="row g-3 mt-5" action="/AddTradeDoc" method="POST" enctype="multipart/form-data">
@csrf
