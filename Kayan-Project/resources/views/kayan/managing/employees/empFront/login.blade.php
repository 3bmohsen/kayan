...
<style>
    ...
    display: flex;
    align-items: center;
    background-image: linear-gradient(to right, #1f9269, #6eb99a);
}
</style>
<body>
    <div class="uf-form-signin">
      <div class="text-center">
      <a class=" text-dark" style="font-weight:bold;">مؤسسة كيان</a>
      <h1 class="text-dark h3" style="font-weight:bold;">تسجيل دخول الموظف</h1>
      </div>
