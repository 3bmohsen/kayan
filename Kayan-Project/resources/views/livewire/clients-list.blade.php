...
<div class="modal" id="sure{{$client->id}}" tabindex="-1" aria-labelledby="sure{{$client->id}}" aria-hidden="true">
<div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title fs-5 text-center cairo-bold" id="sure{{$client->id}}">تحذير</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
        <div class="modal-body text-center">
          هل انت متأكد من حذف العميل {{$client->name}}
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">إغلاق</button>
          <a href="/del/client/{{$client->id}}"><button type="button" class="btn btn-danger">حذف العميل</button></a>
        </div>
      </div>
    </div>
  </div>
