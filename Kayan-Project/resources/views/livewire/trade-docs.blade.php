    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-footer">
          ...
          <a href="/del/tradeDocs/{{$doc->id}}"><button type="button" class="btn btn-danger">حذف</button></a>
        </div>
      </div>
    </div>
  </div>
...
<div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body text-center">
        <form class="row g-3 mt-5" action="/tradeDocs/edit/{{$doc->id}}" method="POST" enctype="multipart/form-data">
        @method('PUT')
  @csrf
  <input required type="hidden" value="5" name="filetype">
  <div class="col-md-6">
