...
<div class="d-flex flex-column flex-md-row " >
        @if ($doc->file_path != null)
          ...
          @endif
            ...
            <a href="" data-bs-toggle="modal" data-bs-target="#edit{{$doc->id}}" class="btn btn-primary m-3 mb-0">تعديل البطاقة</a>
            <a href="" data-bs-toggle="modal" data-bs-target="#sure{{$doc->id}}" class="btn btn-danger m-3 mb-0">حذف البطاقة</a>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body text-center">
          هل انت متأكد من حذف البطاقة {{$doc->file_name}}
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">إغلاق</button>
          <a href="/del/TaxCard/{{$doc->id}}"><button type="button" class="btn btn-danger">حذف البطاقة</button></a>
        </div>
      </div>
    </div>
  </div>
...
<div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title fs-5 text-center cairo-bold" id="edit{{$doc->id}}">تعديل البطاقة</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
        <div class="modal-body text-center">
  ...
  <div class="col-md-6">
    <label for="doc_name" class="form-label">اسم البطاقة</label>
  ...
  <div class="col-12 text-center mb-5">
    <button type="submit" class="btn btn-primary">تعديل البطاقة</button>
  </div>
</form>
        </div>
        <div class="modal-footer">
