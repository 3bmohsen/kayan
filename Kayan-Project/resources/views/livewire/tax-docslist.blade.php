        ...
        @if ($doc->file_path != null)
          ...
          @endif
            ...
            <div class="d-flex flex-row justify-content-lg-start justify-content-center p-3">
                ...
                <p class="p-2">تاريخ التقديم : {{$doc->sub_date}}</p>
                <div class=" p-2">
                <p class="">الملاحظات: </p>
                <p class="">{{$doc->notes}}</p>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-footer">
          ...
          <a href="/del/taxdoc/{{$doc->id}}"><button type="button" class="btn btn-danger">حذف الإقرار</button></a>
        </div>
      </div>
    </div>
  </div>
...
<div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body text-center">
        <form class="row g-3 mt-5" action="/taxDoc/edit/{{$doc->id}}" method="POST" enctype="multipart/form-data">
        @method('PUT')
  @csrf
  ...
  <div class="col-md-6">
    <label for="sub_date" class="form-label">تاريخ الإجراء</label>
    <input required type="date" class="form-control" id="sub_date" name="sub_date" value="{{$doc->sub_date}}">
  </div>
  <div class="col-md-6">
