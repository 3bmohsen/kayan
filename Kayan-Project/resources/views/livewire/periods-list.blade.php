        ...
        @if ($doc->file_path != null)
          ...
          @endif
            ...
            <div class="d-flex flex-row justify-content-lg-start justify-content-center p-3">
                ...
                <p class="p-2">تاريخ الإجراء : {{$doc->sub_date}}</p>
                <div class=" p-2">
                <p class="">الملاحظات: </p>
                <p class="">{{$doc->notes}}</p>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-footer">
          ...
          <a href="/del/CheckPeriod/{{$doc->id}}"><button type="button" class="btn btn-danger">حذف الإقرار</button></a>
        </div>
      </div>
    </div>
  </div>
...
<div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body text-center">
        <form class="row g-3 mt-5" action="/CheckPeriod/edit/{{$doc->id}}" method="POST" enctype="multipart/form-data">
        @method('PUT')
  @csrf
