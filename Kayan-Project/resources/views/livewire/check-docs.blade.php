        ...
        @if ($doc->file_path != null)
          ...
          @endif
            ...
            <div class="d-flex flex-row justify-content-lg-start justify-content-center p-3">
                ...
                <p class="p-2">تاريخ الإجراء : {{$doc->action_date}}</p>
                <div class=" p-2">
                <p class="">الملاحظات: </p>
                <p class="">{{$doc->notes}}</p>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-footer">
          ...
          <a href="/del/checkdoc/{{$doc->id}}"><button type="button" class="btn btn-danger">حذف الإقرار</button></a>
        </div>
      </div>
    </div>
  </div>
...
<div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body text-center">
        <form class="row g-3 mt-5" action="/Checkdoc/edit/{{$doc->id}}" method="POST" enctype="multipart/form-data">
        @method('PUT')
  @csrf
  ...
  <div class="col-md-6">
    <label for="action_date" class="form-label">تاريخ الإجراء</label>
    <input required type="date" class="form-control" id="action_date" name="action_date" value="{{$doc->action_date}}">
  </div>
  <div class="col-md-6">
